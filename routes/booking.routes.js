...
import { cancelBooking, completeBooking, createBooking, getOwnerRoomBookings, makePayment } from "../controllers/booking.controllers.js";
...
bookingRoutes.get("/", authorize(["propertyOwner"]), getOwnerRoomBookings);
